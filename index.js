...
const GUILDID = '892096095214260274'; // اي دي السيرفر  
const CHANNELID = '1010580188108697650'; // اي دي الروم
...
client.on("ready", () => {
  ...
  client.user.setActivity(`قرأن كريم`, { type: "LISTENING" });
});

const url = 'https://qurango.net/radio/abdulrahman_almajed'; //  قناة الراديو هنا // CODE BY KAHRBAA 
